...
test_urls = pd.read_csv("results/linear_buffer_results/visited_value.csv")['url'].tolist()
print(len(test_urls))
...
pd.DataFrame.from_dict(results_dict).to_csv("results/linear_buffer_results/actual_value_visited.csv", index=False)
print("Done.")