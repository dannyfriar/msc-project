...
def main():
	...
	# pd.DataFrame.from_dict({"url": clean_link_list}).to_csv("../new_data/second_hop_links.csv", index=False)
	# pdb.set_trace()
	...
	# print("Checking proportion of links...")
	# total = 0
