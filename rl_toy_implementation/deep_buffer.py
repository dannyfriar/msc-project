...
class CrawlerAgent(object):
	...
	def build_target_net(self):
		self.t_w1 = tf.get_variable("t_w1", [self.weights_shape, 100], initializer=tf.random_normal_initializer(mean=0.0, stddev=0.001))
		self.t_w2 = tf.get_variable("t_w2", [100, 50], initializer=tf.random_normal_initializer(mean=0.0, stddev=0.001))
		self.t_w3 = tf.get_variable("t_w3", [50, 1], initializer=tf.random_normal_initializer(mean=0.0, stddev=0.001))
		self.t_b1 = tf.get_variable("t_b1", [100], initializer=tf.constant_initializer(0.001))
		self.t_b2 = tf.get_variable("t_b2", [50], initializer=tf.constant_initializer(0.001))
	...
	def build_train_net(self):
		self.w1 = tf.get_variable("w1", [self.weights_shape, 100], initializer=tf.random_normal_initializer(mean=0.0, stddev=0.001))
		self.w2 = tf.get_variable("w2", [100, 50], initializer=tf.random_normal_initializer(mean=0.0, stddev=0.001))
		self.w3 = tf.get_variable("w3", [50, 1], initializer=tf.random_normal_initializer(mean=0.0, stddev=0.001))
		self.b1 = tf.get_variable("b1", [100], initializer=tf.constant_initializer(0.001))
		self.b2 = tf.get_variable("b2", [50], initializer=tf.constant_initializer(0.001))
		self.b3 = tf.get_variable("b3", [1], initializer=tf.constant_initializer(0.001))

		self.h1 = tf.nn.sigmoid(tf.matmul(self.state, self.w1) + self.b1)
