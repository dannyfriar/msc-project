...
RESULTS_FOLDER = "results/embedding_anchor_results/"
MODEL_FOLDER = "models/"
	...
	def target_net(self):
		...
		for i, filter_size in enumerate(self.filter_sizes):
			with tf.name_scope("target-conv-maxpool-%s" % filter_size):
				...
				W_target = tf.Variable(tf.truncated_normal(filter_shape, stddev=0.1), name="W_target")
...
def main():
	...
	model_save_file = MODEL_FOLDER + "embeddings_anchor"
