...
def main():
	...
	# Start URLs
	start_url_list = ['https://www.indeed.co.uk/jobs-in-London', 'http://www.thisismoney.co.uk/',
	'http://www.bbc.co.uk/news/business', 'https://www.reed.co.uk/jobs', 'https://www.monster.co.uk/jobs/']
	...
	# File locations
	all_urls_file = RESULTS_FOLDER + "test_async.csv"
